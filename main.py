...
process_train = True  # train a network
process_load = False  # load a network
process_save = True   # save a network
...
def load_vgg(sess, vgg_path):
    ...
    graph = tf.get_default_graph()                              # Retrieves the graph of the (Tensorflow) NN
